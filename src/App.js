      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path='/health' element={<News key='health' pageSize={6} country='in' category='food'/>}/>
            ...
            <Route exact path='/technology' element={<News key='technology' pageSize={6} country='in' category='tech'/>}/>
