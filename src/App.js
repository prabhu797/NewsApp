      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path='health' element={<News setProgress={this.setProgress} key='health' category='food'/>}/>
            ...
            <Route exact path='technology' element={<News setProgress={this.setProgress} key='technology' category='tech'/>}/>
